...
export const el: TranslationBundle = {
  ...
  confirmation: {
    ...
    cta_dashboard: 'Προβολή Dashboard',
    description: 'Η γνώμη σας είναι πολύτιμη και βοηθά να διαμορφώσουμε το μέλλον του YoJob.',
    cta: 'Επιστροφή στον ιστότοπο YoJob',
    
    reward: {
      report: {
        title: 'Αναφορά "Τάσεις 2025"',
        description: 'Αποστολή εντός 3 εβδομάδων'
      },
      earlyaccess: {
        title: 'Πρόωρη πρόσβαση YoJob',
        description: 'Κορυφαίοι 100 συμμετέχοντες'
      }
    },
    
    thanks: {
      title: '🎁 Ως ευχαριστίες για τη συμμετοχή σας:',
      item1: '• Αποκλειστική αναφορά "Τάσεις απόσπασης 2025"',
      item2: '• Κορυφαίοι 100 συμμετέχοντες = 3 μήνες δωρεάν πρόσβαση στο YoJob (αξία 500€)'
    }
  },
