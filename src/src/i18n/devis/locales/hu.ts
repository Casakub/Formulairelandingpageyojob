...
export const hu: DevisTranslations = {
  ...
  pageRecap: {
    ...
    exigences: {
      title: "Jelölti követelmények",
      experience: "Tapasztalat",
      competences: "Kompetenciák",
      langues: "Nyelvek",
      permis: "Jogosítványok",
      epi: "EVF",
    },
    calculs: {
      title: "Díjszabás számítások",
      salaireBrut: "Bruttó bér",
      coefficientETT: "Ügynökségi együttható",
      tauxHoraireBrut: "Bruttó órabér",
      tauxETT: "Ügynökségi díjszabás",
      baseHoraire: "Óraalap",
      coutMensuel: "Havi költség",
      duree: "Időtartam",
      coutTotal: "Teljes költség",
    },
    signature: {
      title: "Elektronikus aláírás",
      intro: "Megerősítem, hogy elolvastam és elfogadom ezen árajánlat feltételeit.",
      nomComplet: {
        label: "Teljes név",
        placeholder: "Nagy János",
      },
      email: {
        label: "Megerősítő e-mail",
        placeholder: "nagy.janos@ceg.hu",
      },
      checkbox: "Elfogadom az általános szerződési feltételeket",
      boutonSigner: "Elektronikus aláírás",
      enCours: "Aláírás...",
      succes: "✓ Árajánlat sikeresen aláírva!",
      erreur: "Hiba az aláíráskor. Kérjük, próbálja újra.",
    },
    actions: {
