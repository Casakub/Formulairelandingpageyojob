...
export const fr: DevisTranslations = {
  ...
  // === PAGE RÉCAPITULATIF DEVIS (SIGNATURE) ===
  pageRecap: {
    header: {
    ...
    postes: {
      ...
      tauxHoraireBrut: "Taux horaire brut",
      coefficientETT: "Coefficient ETT",
      tauxETT: "Taux ETT",
    },
    conditions: {
      title: "Conditions de travail",
      ...
      baseHoraire: "Base horaire",
      heuresMois: "h/mois",
      lieuxMission: "Lieux de mission",
      motifRecours: "Motif de recours",
    },
    candidats: {
      title: "Profil des candidats recherchés",
      experience: "Expérience",
      ansMinimum: "ans minimum",
      formation: "Formation",
      permis: "Permis",
      langues: "Langues",
    },
    signature: {
      ...
      subtitle: "Signez votre devis en ligne de manière sécurisée",
      commencer: "Commencer la signature",
      identiteSignataire: "Identité du signataire",
      nomComplet: "Nom complet",
      fonction: "Fonction",
      email: "Email",
      ...
      effacer: "Effacer",
      accepteCGV: "J'accepte les",
      cgvLien: "Conditions Générales de Vente",
      accepteCGVSuite: "et certifie que les informations fournies sont exactes. Cette signature électronique a la même valeur légale qu'une signature manuscrite.",
      annuler: "Annuler",
      validerSigner: "Valider et signer",
      signatureEnCours: "Signature en cours...",
      erreurSignatureVide: "Veuillez signer avant de valider",
      erreurCGV: "Veuillez accepter les CGV",
    },
    succes: {
      title: "Devis signé avec succès !",
      message: "Ce devis a été signé électroniquement. Vous recevrez prochainement un email de confirmation avec le PDF final.",
      signeLe: "Signé le",
    },
    erreurs: {
      chargement: "Impossible de charger le devis",
      generation: "Impossible de générer le PDF",
      signature: "Impossible de signer le devis",
    },
    toast: {
      pdfEnCours: "Génération du PDF en cours...",
      pdfSucces: "PDF généré avec succès !",
      signatureSucces: "Devis signé avec succès ! Un email de confirmation vous a été envoyé.",
    },
  },
};