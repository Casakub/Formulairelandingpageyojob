...
export const lv: DevisTranslations = {
  ...
  pageRecap: {
    ...
    candidats: {
      title: "Meklēto kandidātu profils",
      experience: "Pieredze",
      ansMinimum: "gadi minimums",
      formation: "Izglītība",
      permis: "Vadītāja apliecība",
      langues: "Valodas",
    },
    signature: {
      title: "Elektroniskais paraksts",
      subtitle: "Parakstiet savu piedāvājumu droši tiešsaistē",
      commencer: "Sākt parakstīšanu",
      identiteSignataire: "Parakstītāja identitāte",
      nomComplet: "Pilns vārds",
      fonction: "Amats",
      email: "E-pasts",
      entreprise: "Uzņēmums",
      siret: "SIRET",
      signataire: "Parakstītājs",
      tracabilite: "Tehniskā izsekojamība",
      dateHeure: "Datums un laiks",
      adresseIP: "IP adrese",
      navigateur: "Pārlūkprogramma",
      signatureManuscrite: "Rokraksta paraksts",
      infoLegale: "🔒 Šī informācija tiks ierakstīta elektroniskā paraksta sertifikātā, lai nodrošinātu izsekojamību un juridisko atbilstību saskaņā ar eIDAS regulu (ES) Nr. 910/2014.",
      dessinerSignature: "Uzzīmējiet savu parakstu zemāk",
      effacer: "Dzēst",
      accepteCGV: "Piekrītu",
      cgvLien: "Vispārējiem pārdošanas nosacījumiem",
      accepteCGVSuite: "un apliecinu, ka sniegtā informācija ir precīza. Šim elektroniskajam parakstam ir tāda pati juridiskā vērtība kā rokraksta parakstam.",
      annuler: "Atcelt",
      validerSigner: "Apstiprināt un parakstīt",
      signatureEnCours: "Paraksta...",
      erreurSignatureVide: "Lūdzu, parakstiet pirms apstiprināšanas",
      erreurCGV: "Lūdzu, piekrītiet Vispārējiem nosacījumiem",
    },
    actions: {
