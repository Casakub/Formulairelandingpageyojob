...
export const sl: DevisTranslations = {
  ...
  pageRecap: {
    ...
    exigences: {
      title: "Zahteve za kandidate",
      experience: "Izkušnje",
      competences: "Kompetence",
      langues: "Jeziki",
      permis: "Vozniška dovoljenja",
      epi: "OZO",
    },
    calculs: {
      title: "Izračuni stopenj",
      salaireBrut: "Bruto plača",
      coefficientETT: "Koeficient agencije",
      tauxHoraireBrut: "Bruto urna postavka",
      tauxETT: "Stopnja agencije",
      baseHoraire: "Urna osnova",
      coutMensuel: "Mesečni stroški",
      duree: "Trajanje",
      coutTotal: "Skupni stroški",
    },
    signature: {
      title: "Elektronski podpis",
      intro: "Potrjujem, da sem prebral/a in sprejemam pogoje te ponudbe.",
      nomComplet: {
        label: "Polno ime",
        placeholder: "Janez Novak",
      },
      email: {
        label: "Potrditvena e-pošta",
        placeholder: "janez.novak@podjetje.si",
      },
      checkbox: "Sprejemam splošne pogoje poslovanja",
      boutonSigner: "Elektronsko podpiši",
      enCours: "Podpisovanje...",
      succes: "✓ Ponudba uspešno podpisana!",
      erreur: "Napaka pri podpisovanju. Prosimo, poskusite znova.",
    },
    actions: {
