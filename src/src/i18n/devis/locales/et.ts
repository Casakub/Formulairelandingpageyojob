...
export const et: DevisTranslations = {
  ...
  pageRecap: {
    ...
    candidats: {
      title: "Otsitavate kandidaatide profiil",
      experience: "Kogemus",
      ansMinimum: "aastat miinimum",
      formation: "Haridus",
      permis: "Juhiload",
      langues: "Keeled",
    },
    signature: {
      ...
      subtitle: "Allkirjastage oma pakkumine turvaliselt veebis",
      commencer: "Alusta allkirjastamist",
      identiteSignataire: "Allkirjastaja isik",
      nomComplet: "Täisnimi",
      fonction: "Ametinimetus",
      email: "E-post",
      entreprise: "Ettevõte",
      siret: "SIRET",
      signataire: "Allkirjastaja",
      tracabilite: "Tehniline jälgitavus",
      dateHeure: "Kuupäev ja kellaaeg",
      adresseIP: "IP-aadress",
      navigateur: "Brauser",
      signatureManuscrite: "Käsitsi kirjutatud allkiri",
      infoLegale: "🔒 Need andmed salvestatakse elektroonilise allkirja sertifikaati, et tagada jälgitavus ja õiguslik vastavus vastavalt eIDAS määrusele (EL) nr 910/2014.",
      dessinerSignature: "Joonistage oma allkiri allpool",
      effacer: "Kustuta",
      accepteCGV: "Nõustun",
      cgvLien: "Üldiste müügitingimustega",
      accepteCGVSuite: "ja kinnitan, et esitatud teave on õige. Sellel elektrooniline allkirjal on sama õiguslik väärtus kui käsitsi kirjutatud allkirjal.",
      annuler: "Tühista",
      validerSigner: "Kinnita ja allkirjasta",
      signatureEnCours: "Allkirjastamine käib...",
      erreurSignatureVide: "Palun allkirjastage enne kinnitamist",
      erreurCGV: "Palun nõustuge Üldiste Tingimustega",
    },
    actions: {
      modifier: "Muuda pakkumist",
