...
export const el: DevisTranslations = {
  ...
  pageRecap: {
    ...
    candidats: {
      title: "Προφίλ αναζητούμενων υποψηφίων",
      experience: "Εμπειρία",
      ansMinimum: "έτη ελάχιστο",
      formation: "Εκπαίδευση",
      permis: "Άδεια οδήγησης",
      langues: "Γλώσσες",
    },
    signature: {
      title: "Ηλεκτρονική υπογραφή",
      subtitle: "Υπογράψτε την προσφορά σας με ασφάλεια online",
      commencer: "Έναρξη υπογραφής",
      identiteSignataire: "Ταυτότητα υπογράφοντος",
      nomComplet: "Πλήρες όνομα",
      fonction: "Θέση",
      email: "Email",
      entreprise: "Εταιρεία",
      siret: "SIRET",
      signataire: "Υπογράφων",
      tracabilite: "Τεχνική ιχνηλασιμότητα",
      dateHeure: "Ημερομηνία και ώρα",
      adresseIP: "Διεύθυνση IP",
      navigateur: "Περιηγητής",
      signatureManuscrite: "Χειρόγραφη υπογραφή",
      infoLegale: "🔒 Αυτές οι πληροφορίες θα καταγραφούν στο πιστοποιητικό ηλεκτρονικής υπογραφής για να διασφαλιστεί η ιχνηλασιμότητα και η νομική συμμόρφωση σύμφωνα με τον κανονισμό eIDAS (ΕΕ) αριθ. 910/2014.",
      dessinerSignature: "Σχεδιάστε την υπογραφή σας παρακάτω",
      effacer: "Διαγραφή",
      accepteCGV: "Αποδέχομαι",
      cgvLien: "τους Γενικούς Όρους Πώλησης",
      accepteCGVSuite: "και επιβεβαιώνω ότι οι παρεχόμενες πληροφορίες είναι ακριβείς. Αυτή η ηλεκτρονική υπογραφή έχει την ίδια νομική ισχύ με τη χειρόγραφη υπογραφή.",
      annuler: "Ακύρωση",
      validerSigner: "Επικύρωση και υπογραφή",
      signatureEnCours: "Υπογραφή σε εξέλιξη...",
      erreurSignatureVide: "Παρακαλώ υπογράψτε πριν την επικύρωση",
      erreurCGV: "Παρακαλώ αποδεχτείτε τους Γενικούς Όρους",
    },
    actions: {
