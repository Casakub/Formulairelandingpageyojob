...
export const lt: DevisTranslations = {
  ...
  pageRecap: {
    ...
    candidats: {
      title: "Ieškomų kandidatų profilis",
      experience: "Patirtis",
      ansMinimum: "metų minimumas",
      formation: "Išsilavinimas",
      permis: "Vairuotojo pažymėjimas",
      langues: "Kalbos",
    },
    signature: {
      title: "Elektroninis parašas",
      subtitle: "Pasirašykite savo pasiūlymą saugiai internetu",
      commencer: "Pradėti pasirašymą",
      identiteSignataire: "Pasirašančiojo tapatybė",
      nomComplet: "Pilnas vardas",
      fonction: "Pareigos",
      email: "El. paštas",
      entreprise: "Įmonė",
      siret: "SIRET",
      signataire: "Pasirašantysis",
      tracabilite: "Techninis atsekamumas",
      dateHeure: "Data ir laikas",
      adresseIP: "IP adresas",
      navigateur: "Naršyklė",
      signatureManuscrite: "Rankinis parašas",
      infoLegale: "🔒 Ši informacija bus įrašyta į elektroninio parašo sertifikatą, kad būtų užtikrintas atsekamumas ir teisinis atitikimas pagal eIDAS reglamentą (ES) Nr. 910/2014.",
      dessinerSignature: "Nubrėžkite savo parašą žemiau",
      effacer: "Ištrinti",
      accepteCGV: "Sutinku su",
      cgvLien: "Bendrosiomis pardavimo sąlygomis",
      accepteCGVSuite: "ir patvirtinu, kad pateikta informacija yra tiksli. Šis elektroninis parašas turi tokią pačią teisinę galią kaip ir rankinis parašas.",
      annuler: "Atšaukti",
      validerSigner: "Patvirtinti ir pasirašyti",
      signatureEnCours: "Pasirašoma...",
      erreurSignatureVide: "Prašome pasirašyti prieš patvirtinant",
      erreurCGV: "Prašome sutikti su Bendrosiomis sąlygomis",
    },
    actions: {
