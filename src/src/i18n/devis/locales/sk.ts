...
export const sk: DevisTranslations = {
  ...
  pageRecap: {
    ...
    candidats: {
      title: "Profil hľadaných kandidátov",
      experience: "Skúsenosti",
      ansMinimum: "rokov minimálne",
      formation: "Vzdelanie",
      permis: "Vodičský preukaz",
      langues: "Jazyky",
    },
    signature: {
      title: "Elektronický podpis",
      subtitle: "Podpíšte svoju ponuku bezpečne online",
      commencer: "Začať podpisovanie",
      identiteSignataire: "Totožnosť podpisujúceho",
      nomComplet: "Celé meno",
      fonction: "Funkcia",
      email: "E-mail",
      entreprise: "Spoločnosť",
      siret: "SIRET",
      signataire: "Podpisujúci",
      tracabilite: "Technická sledovateľnosť",
      dateHeure: "Dátum a čas",
      adresseIP: "IP adresa",
      navigateur: "Prehliadač",
      signatureManuscrite: "Ručný podpis",
      infoLegale: "🔒 Tieto informácie budú zaznamenané v certifikáte elektronického podpisu na zabezpečenie sledovateľnosti a právnej zhody v súlade s nariadením eIDAS (EÚ) č. 910/2014.",
      dessinerSignature: "Nakreslite svoj podpis nižšie",
      effacer: "Vymazať",
      accepteCGV: "Prijímam",
      cgvLien: "Všeobecné obchodné podmienky",
      accepteCGVSuite: "a potvrdzujem, že poskytnuté informácie sú presné. Tento elektronický podpis má rovnakú právnu hodnotu ako ručný podpis.",
      annuler: "Zrušiť",
      validerSigner: "Potvrdiť a podpísať",
      signatureEnCours: "Podpisovanie prebieha...",
      erreurSignatureVide: "Pred potvrdením prosím podpíšte",
      erreurCGV: "Prosím prijmite Všeobecné podmienky",
    },
    actions: {
