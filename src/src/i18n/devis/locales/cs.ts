...
export const cs: DevisTranslations = {
  ...
  pageRecap: {
    ...
    candidats: {
      title: "Profil hledaných kandidátů",
      experience: "Zkušenosti",
      ansMinimum: "let minimálně",
      formation: "Vzdělání",
      permis: "Řidičský průkaz",
      langues: "Jazyky",
    },
    signature: {
      title: "Elektronický podpis",
      subtitle: "Podepište svou nabídku bezpečně online",
      commencer: "Zahájit podepisování",
      identiteSignataire: "Totožnost podepisujícího",
      nomComplet: "Celé jméno",
      fonction: "Funkce",
      email: "E-mail",
      entreprise: "Společnost",
      siret: "SIRET",
      signataire: "Podepisující",
      tracabilite: "Technická sledovatelnost",
      dateHeure: "Datum a čas",
      adresseIP: "IP adresa",
      navigateur: "Prohlížeč",
      signatureManuscrite: "Ruční podpis",
      infoLegale: "🔒 Tyto informace budou zaznamenány v certifikátu elektronického podpisu pro zajištění sledovatelnosti a právní shody v souladu s nařízením eIDAS (EU) č. 910/2014.",
      dessinerSignature: "Nakreslete svůj podpis níže",
      effacer: "Vymazat",
      accepteCGV: "Přijímám",
      cgvLien: "Všeobecné obchodní podmínky",
      accepteCGVSuite: "a potvrzuji, že poskytnuté informace jsou přesné. Tento elektronický podpis má stejnou právní hodnotu jako ruční podpis.",
      annuler: "Zrušit",
      validerSigner: "Potvrdit a podepsat",
      signatureEnCours: "Podepisování probíhá...",
      erreurSignatureVide: "Před potvrzením prosím podepište",
      erreurCGV: "Prosím přijměte Všeobecné podmínky",
    },
    actions: {
