...
export const hr: DevisTranslations = {
  ...
  pageRecap: {
    ...
    exigences: {
      title: "Zahtjevi za kandidate",
      experience: "Iskustvo",
      competences: "Kompetencije",
      langues: "Jezici",
      permis: "Vozačke dozvole",
      epi: "OZO",
    },
    calculs: {
      title: "Izračuni stopa",
      salaireBrut: "Bruto plaća",
      coefficientETT: "Koeficijent agencije",
      tauxHoraireBrut: "Bruto satnica",
      tauxETT: "Stopa agencije",
      baseHoraire: "Satna osnova",
      coutMensuel: "Mjesečni troškovi",
      duree: "Trajanje",
      coutTotal: "Ukupni troškovi",
    },
    signature: {
      title: "Elektronički potpis",
      intro: "Potvrđujem da sam pročitao/la i prihvaćam uvjete ove ponude.",
      nomComplet: {
        label: "Puno ime",
        placeholder: "Ivan Horvat",
      },
      email: {
        label: "Potvrdni e-mail",
        placeholder: "ivan.horvat@tvrtka.hr",
      },
      checkbox: "Prihvaćam opće uvjete poslovanja",
      boutonSigner: "Elektronički potpiši",
      enCours: "Potpisivanje...",
      succes: "✓ Ponuda uspješno potpisana!",
      erreur: "Greška pri potpisivanju. Molimo pokušajte ponovno.",
    },
    actions: {
