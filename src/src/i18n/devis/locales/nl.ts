...
export const nl: DevisTranslations = {
  ...
  pageRecap: {
    ...
    candidats: {
      title: "Gezocht kandidatenprofiel",
      experience: "Ervaring",
      ansMinimum: "jaar minimum",
      formation: "Opleiding",
      permis: "Rijbewijs",
      langues: "Talen",
    },
    signature: {
      ...
      subtitle: "Onderteken uw offerte veilig online",
      commencer: "Begin met ondertekenen",
      identiteSignataire: "Identiteit ondertekenaar",
      nomComplet: "Volledige naam",
      fonction: "Functie",
      email: "E-mail",
      entreprise: "Bedrijf",
      ...
      tracabilite: "Technische traceerbaarheid",
      dateHeure: "Datum en tijd",
      adresseIP: "IP-adres",
      navigateur: "Browser",
      signatureManuscrite: "Handgeschreven handtekening",
      infoLegale: "🔒 Deze informatie wordt opgenomen in het elektronische handtekeningcertificaat om traceerbaarheid en wettelijke naleving volgens de eIDAS-verordening (EU) nr. 910/2014 te waarborgen.",
      dessinerSignature: "Teken hieronder uw handtekening",
      effacer: "Wissen",
      accepteCGV: "Ik accepteer de",
      cgvLien: "Algemene Verkoopvoorwaarden",
      accepteCGVSuite: "en verklaar dat de verstrekte informatie correct is. Deze elektronische handtekening heeft dezelfde juridische waarde als een handgeschreven handtekening.",
      annuler: "Annuleren",
      validerSigner: "Valideren en ondertekenen",
      signatureEnCours: "Ondertekenen...",
      erreurSignatureVide: "Gelieve te ondertekenen voor validatie",
      erreurCGV: "Gelieve de Algemene Voorwaarden te accepteren",
    },
    actions: {
