...
export const fi: DevisTranslations = {
  ...
  pageRecap: {
    ...
    candidats: {
      title: "Etsittävien hakijoiden profiili",
      experience: "Kokemus",
      ansMinimum: "vuotta vähintään",
      formation: "Koulutus",
      permis: "Ajokortti",
      langues: "Kielet",
    },
    signature: {
      ...
      subtitle: "Allekirjoita tarjouksesi turvallisesti verkossa",
      commencer: "Aloita allekirjoitus",
      identiteSignataire: "Allekirjoittajan henkilöllisyys",
      nomComplet: "Koko nimi",
      fonction: "Tehtävä",
      email: "Sähköposti",
      entreprise: "Yritys",
      siret: "SIRET",
      signataire: "Allekirjoittaja",
      tracabilite: "Tekninen jäljitettävyys",
      dateHeure: "Päivämäärä ja kellonaika",
      adresseIP: "IP-osoite",
      navigateur: "Selain",
      signatureManuscrite: "Käsinkirjoitettu allekirjoitus",
      infoLegale: "🔒 Nämä tiedot tallennetaan sähköisen allekirjoituksen varmenteeseen jäljitettävyyden ja oikeudellisen vaatimustenmukaisuuden varmistamiseksi eIDAS-asetuksen (EU) N:o 910/2014 mukaisesti.",
      dessinerSignature: "Piirrä allekirjoituksesi alle",
      effacer: "Tyhjennä",
      accepteCGV: "Hyväksyn",
      cgvLien: "Yleiset myyntiehdot",
      accepteCGVSuite: "ja vahvistan, että annetut tiedot ovat oikein. Tällä sähköisellä allekirjoituksella on sama oikeudellinen arvo kuin käsinkirjoitetulla allekirjoituksella.",
      annuler: "Peruuta",
      validerSigner: "Vahvista ja allekirjoita",
      signatureEnCours: "Allekirjoitetaan...",
      erreurSignatureVide: "Ole hyvä ja allekirjoita ennen vahvistamista",
      erreurCGV: "Ole hyvä ja hyväksy Yleiset ehdot",
    },
    actions: {
