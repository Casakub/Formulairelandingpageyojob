...
export const sv: DevisTranslations = {
  ...
  // === VERKSAMHETSOMRÅDEN & YRKEN ===
  secteurs: {
    batiment: {
      label: "Byggnad",
      convention: "Nationellt kollektivavtal byggnadsarbetare (3193)",
      postes: {
        macon: "Murare",
        coffreur: "Formsnickar",
        ferrailleur: "Armeringsarbetare",
        carreleur: "Plattläggare",
        platrier: "Puts- och gipsarbetare",
        peintre: "Målare",
        plombier: "Rörmokare",
        electricien: "Elektriker",
        couvreur: "Takläggare",
        menuisier: "Snickare",
        chef_equipe_batiment: "Arbetsledare",
        chef_chantier: "Byggplatschef",
      },
      classifications: {
        n1p1: "N1P1",
        n1p2: "N1P2",
    ...
    metallurgie: {
      label: "Metallurgi",
      convention: "Kollektivavtal metallurgi (3109)",
      postes: {
        soudeur: "Svetsare",
        chaudronnier: "Plåtslagare",
        tuyauteur: "Rörmontör",
        tourneur: "Svarvare",
        fraiseur: "Fräsare",
        usineur: "CNC-operatör",
        mecanicien_industriel: "Industrimekaniker",
        monteur: "Montör",
        controleur_qualite: "Kvalitetskontrollant",
        ajusteur: "Justerare",
        chef_equipe_metallurgie: "Arbetsledare",
      },
      classifications: {
        niveau_1: "Nivå I",
        niveau_2: "Nivå II",
    ...
    tp: {
      ...
      convention: "Nationellt kollektivavtal anläggningsarbeten (3005)",
      postes: {
        conducteur_engins: "Maskinförare",
        terrassier: "Markarbetare",
        canalisateur: "Avloppsarbetare",
        constructeur_routes: "Vägbyggare",
        coffreur_bancheur: "Formsnickar",
        macon_vrd: "Murare anläggning",
        chef_equipe_tp: "Arbetsledare anläggning",
        manoeuvre_tp: "Hantlangare anläggning",
      },
      classifications: {
        n1: "N1",
        n2: "N2",
    ...
    hotellerie: {
      label: "Hotellverksamhet",
      convention: "Kollektivavtal hotell-restaurang (3292)",
      postes: {
        receptionniste: "Receptionist",
        femme_chambre: "Städare",
        agent_entretien: "Underhållsarbetare",
        bagagiste: "Piccolo",
        concierge: "Concierge",
        night_audit: "Nattreceptionist",
        gouvernante: "Hushållerska",
    ...
    plasturgie: {
      ...
      postes: {
        operateur_injection: "Insprutningsoperatör",
        ...
        chef_equipe_plasturgie: "Arbetsledare",
      },
      classifications: {
        niveau_1: "Nivå I",
        niveau_2: "Nivå II",
    ...
    automobile_carrosserie: {
      label: "Bilindustri & Karosseriverkstad",
      convention: "Kollektivavtal bilreparation (1090)",
      postes: {
        carrossier: "Karosserimekaniker",
    ...
    sylviculture: {
      ...
      postes: {
        ...
        elagueur: "Trädklippare",
        conducteur_engins_forestiers: "Skogsmaskinsförare",
        chef_equipe_sylviculture: "Arbetsledare skogsbruk",
      },
      classifications: {
        niveau_1: "Nivå I",
        niveau_2: "Nivå II",
    ...
    cartonnerie: {
      ...
      postes: {
        ...
        chef_equipe_cartonnerie: "Arbetsledare",
      },
      classifications: {
        niveau_1: "Nivå I",
        niveau_2: "Nivå II",
    ...
    autre: {
      label: "Annat",
      convention: "Ska definieras enligt verksamhetsområde",
      postes: {
        autre_poste: "Annan befattning (specificera)",
      },
      classifications: {
        a_definir: "Ska definieras",
      },
    },
  },
  ...
  pageRecap: {
    ...
    calculs: {
      title: "Prisberäkningar",
      salaireBrut: "Bruttolön",
      coefficientETT: "Byråkoefficient",
      tauxHoraireBrut: "Bruttotimlön",
      tauxETT: "Byråpris",
      baseHoraire: "Timbas",
      coutMensuel: "Månadskostnad",
      duree: "Varaktighet",
      coutTotal: "Totalkostnad",
    },
    signature: {
      title: "Elektronisk signering",
      intro: "Jag bekräftar att jag har läst och godkänner villkoren i denna offert.",
      nomComplet: {
        label: "Fullständigt namn",
        placeholder: "Erik Andersson",
      },
      email: {
        label: "Bekräftelse-e-post",
        placeholder: "erik.andersson@foretag.se",
      },
      checkbox: "Jag godkänner de allmänna villkoren",
      boutonSigner: "Signera elektroniskt",
      enCours: "Signerar...",
      succes: "✓ Offerten har signerats framgångsrikt!",
      erreur: "Fel vid signering. Vänligen försök igen.",
    },
    actions: {
