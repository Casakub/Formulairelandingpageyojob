...
export const da: DevisTranslations = {
  ...
  pageRecap: {
    ...
    candidats: {
      title: "Profil for ønskede kandidater",
      experience: "Erfaring",
    ...
    signature: {
      ...
      subtitle: "Underskriv dit tilbud sikkert online",
      commencer: "Begynd at underskrive",
      identiteSignataire: "Underskriverens identitet",
      nomComplet: "Fulde navn",
      fonction: "Stilling",
      email: "E-mail",
      entreprise: "Virksomhed",
      siret: "SIRET",
      signataire: "Underskriver",
      tracabilite: "Teknisk sporbarhed",
      dateHeure: "Dato og tid",
      adresseIP: "IP-adresse",
      navigateur: "Browser",
      signatureManuscrite: "Håndskrevet underskrift",
      infoLegale: "🔒 Disse oplysninger vil blive registreret i det elektroniske underskriftscertifikat for at sikre sporbarhed og juridisk overholdelse i henhold til eIDAS-forordningen (EU) nr. 910/2014.",
      dessinerSignature: "Tegn din underskrift nedenfor",
      effacer: "Slet",
      accepteCGV: "Jeg accepterer",
      cgvLien: "de generelle salgsbetingelser",
      accepteCGVSuite: "og bekræfter, at de angivne oplysninger er korrekte. Denne elektroniske underskrift har samme juridiske værdi som en håndskrevet underskrift.",
      annuler: "Annuller",
      validerSigner: "Bekræft og underskriv",
      signatureEnCours: "Underskriver...",
      erreurSignatureVide: "Venligst underskriv før bekræftelse",
      erreurCGV: "Venligst accepter de generelle betingelser",
    },
    actions: {
