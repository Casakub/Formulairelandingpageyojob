...
export const it: DevisTranslations = {
  ...
  pageRecap: {
    ...
    calculs: {
      title: "Calcoli tariffari",
      salaireBrut: "Salario lordo",
      coefficientETT: "Coefficiente agenzia",
      tauxHoraireBrut: "Tariffa oraria lorda",
      tauxETT: "Tariffa agenzia",
      baseHoraire: "Base oraria",
      coutMensuel: "Costo mensile",
      duree: "Durata",
      coutTotal: "Costo totale",
    },
    signature: {
      title: "Firma elettronica",
      intro: "Confermo di aver letto e accettato le condizioni di questo preventivo.",
      nomComplet: {
        label: "Nome e cognome",
        placeholder: "Mario Rossi",
      },
      email: {
        label: "Email di conferma",
        placeholder: "mario.rossi@azienda.it",
      },
      checkbox: "Accetto i termini e le condizioni generali di vendita",
      boutonSigner: "Firma elettronicamente",
      enCours: "Firma in corso...",
      succes: "✓ Preventivo firmato con successo!",
      erreur: "Errore durante la firma. Riprova.",
    },
    actions: {
      modifier: "Modifica il preventivo",
      telecharger: "Scarica PDF",
      partager: "Condividi",
    },
  },
};