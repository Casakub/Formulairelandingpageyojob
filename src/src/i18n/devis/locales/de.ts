...
export const de: DevisTranslations = {
  ...
  pays: {
    ...
    malte: "Malta",
    pays_bas: "Niederlande",
    pologne: "Polen",
    portugal: "Portugal",
    republique_tcheque: "Tschechien",
    roumanie: "Rumänien",
    slovaquie: "Slowakei",
    slovenie: "Slowenien",
    suede: "Schweden",
  ...
  // === ANGEBOTSZUSAMMENFASSUNG SEITE (SIGNATUR) ===
  pageRecap: {
    header: {
      title: "Angebotszusammenfassung",
      exportPDF: "PDF exportieren",
      apercuImpression: "Vorschau & Drucken",
    ...
    dates: {
      creeLe: "Erstellt am",
      a: "um",
      signeLe: "Unterzeichnet am",
      derniereModification: "Letzte Änderung:",
    },
    tooltips: {
      signezPourPDF: "Unterschreiben Sie Ihr Angebot, um das offizielle PDF freizuschalten",
      signezMaintenant: "Jetzt unterschreiben, um Ihr offizielles PDF zu erhalten",
      documentDisponible: "Das Dokument ist sofort nach der Unterzeichnung verfügbar",
      pdfDebloque: "PDF freigeschaltet!",
      telechargerPDF: "Sie können Ihr offizielles Angebot jetzt oben auf der Seite herunterladen",
    },
    modales: {
      apercu: {
        title: "Angebotsvorschau",
        imprimer: "Drucken / Als PDF speichern",
      },
      cgv: {
    ...
    print: {
      courtage: "Europäische Personalvermittlung",
      documentGenere: "Dokument erstellt am",
    },
    entreprise: {
      title: "Unternehmensinformationen",
      raisonSociale: "Firmenname",
      siret: "SIRET",
      codeAPE: "APE-Code",
      tvaIntracommunautaire: "Umsatzsteuer-ID",
      adresse: "Adresse",
      siteInternet: "Webseite",
    },
    contact: {
      title: "Kontaktperson",
      ...
      telephoneFixe: "Festnetz",
    },
    postes: {
      title: "Zu besetzende Stellen",
      nationalite: "Nationalität",
      salaireBrut: "Bruttogehalt",
      tauxHoraireBrut: "Bruttostundenlohn",
      coefficientETT: "ETT-Koeffizient",
      tauxETT: "ETT-Satz",
    },
    conditions: {
      title: "Arbeitsbedingungen",
      dateDebut: "Startdatum",
      dateFin: "Enddatum",
      periodeEssai: "Probezeit",
      baseHoraire: "Zeitbasis",
      heuresMois: "Std/Monat",
      lieuxMission: "Einsatzorte",
      motifRecours: "Grund für Zeitarbeit",
    },
    candidats: {
      title: "Gesuchtes Kandidatenprofil",
      experience: "Erfahrung",
      ansMinimum: "Jahre Minimum",
    ...
    signature: {
      ...
      subtitle: "Unterschreiben Sie Ihr Angebot sicher online",
      commencer: "Signierung beginnen",
      identiteSignataire: "Identität des Unterzeichners",
      nomComplet: "Vollständiger Name",
      fonction: "Funktion",
      email: "E-Mail",
      ...
      tracabilite: "Technische Rückverfolgbarkeit",
      dateHeure: "Datum und Uhrzeit",
      adresseIP: "IP-Adresse",
      navigateur: "Browser",
      signatureManuscrite: "Handschriftliche Unterschrift",
      infoLegale: "🔒 Diese Informationen werden im elektronischen Signaturzertifikat aufgezeichnet, um die Rückverfolgbarkeit und rechtliche Konformität gemäß der eIDAS-Verordnung (EU) Nr. 910/2014 zu gewährleisten.",
      dessinerSignature: "Zeichnen Sie Ihre Unterschrift unten",
      effacer: "Löschen",
      accepteCGV: "Ich akzeptiere die",
      cgvLien: "Allgemeinen Geschäftsbedingungen",
      accepteCGVSuite: "und bestätige, dass die angegebenen Informationen korrekt sind. Diese elektronische Signatur hat den gleichen rechtlichen Wert wie eine handschriftliche Unterschrift.",
      annuler: "Abbrechen",
      validerSigner: "Bestätigen und unterschreiben",
      signatureEnCours: "Signierung läuft...",
      erreurSignatureVide: "Bitte unterschreiben Sie vor der Bestätigung",
      erreurCGV: "Bitte akzeptieren Sie die AGB",
    },
    succes: {
      title: "Angebot erfolgreich unterzeichnet!",
      message: "Dieses Angebot wurde elektronisch unterzeichnet. Sie erhalten in Kürze eine Bestätigungs-E-Mail mit dem endgültigen PDF.",
      signeLe: "Unterzeichnet am",
    },
    erreurs: {
      chargement: "Angebot kann nicht geladen werden",
      generation: "PDF kann nicht generiert werden",
      signature: "Angebot kann nicht unterzeichnet werden",
    },
    toast: {
      pdfEnCours: "PDF wird generiert...",
      pdfSucces: "PDF erfolgreich generiert!",
      signatureSucces: "Angebot erfolgreich unterzeichnet! Eine Bestätigungs-E-Mail wurde Ihnen gesendet.",
    },
  },
};