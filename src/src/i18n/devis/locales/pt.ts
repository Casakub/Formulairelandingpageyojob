...
export const pt: DevisTranslations = {
  ...
  pageRecap: {
    ...
    candidats: {
      title: "Perfil dos candidatos procurados",
      experience: "Experiência",
      ansMinimum: "anos mínimo",
      formation: "Formação",
    ...
    signature: {
      ...
      subtitle: "Assine o seu orçamento online de forma segura",
      commencer: "Iniciar assinatura",
      identiteSignataire: "Identidade do signatário",
      nomComplet: "Nome completo",
      fonction: "Função",
      email: "Email",
      entreprise: "Empresa",
      ...
      tracabilite: "Rastreabilidade técnica",
      dateHeure: "Data e hora",
      adresseIP: "Endereço IP",
      navigateur: "Navegador",
      signatureManuscrite: "Assinatura manuscrita",
      infoLegale: "🔒 Estas informações serão registadas no certificado de assinatura eletrónica para garantir a rastreabilidade e conformidade legal de acordo com o Regulamento eIDAS (UE) n.º 910/2014.",
      dessinerSignature: "Desenhe a sua assinatura abaixo",
      effacer: "Apagar",
      accepteCGV: "Aceito os",
      cgvLien: "Termos e Condições Gerais de Venda",
      accepteCGVSuite: "e certifico que as informações fornecidas são exatas. Esta assinatura eletrónica tem o mesmo valor legal que uma assinatura manuscrita.",
      annuler: "Cancelar",
      validerSigner: "Validar e assinar",
      signatureEnCours: "Assinatura em curso...",
      erreurSignatureVide: "Por favor, assine antes de validar",
      erreurCGV: "Por favor, aceite os Termos e Condições",
    },
    actions: {
