/**
 * 🇫🇷 TRADUCTIONS FRANÇAISES - PAGES SERVICES
 * 
 * @version 1.0.0
 */
...
export const frServices: ServiceTranslations = {
  interimEuropeen: {
    meta: {
      title: "Intérim Européen | Recrutement temporaire en Europe | YOJOB",
      description: "Accédez à 500+ agences d'intérim dans 27 pays européens. Recrutement de personnel temporaire qualifié avec gestion complète des formalités administratives."
    },
    hero: {
      badge: "🇪🇺 Intérim Européen",
      title: "Recrutez du personnel temporaire partout en Europe",
      subtitle: "Accédez à notre réseau de 500+ agences partenaires dans 27 pays. Nous gérons toutes les formalités administratives pour vous.",
      cta: {
        primary: "Demander un devis",
        secondary: "Découvrir le processus"
      }
    },
    forWho: {
      badge: "🎯 Pour qui ?",
      title: "Ce service est fait pour vous",
      userCompanies: {
        title: "Entreprises Utilisatrices",
        description: "Entreprises françaises ou européennes ayant besoin de renforcer ponctuellement leurs équipes avec du personnel qualifié venant d'autres pays européens."
      },
      concerns: {
        title: "Vous êtes concerné si...",
        items: [
    ...
    benefits: {
      title: "Pourquoi choisir notre service d'intérim européen",
    ...
    sectors: {
      ...
      title: "Secteurs concernés par l'intérim européen",
      subtitle: "🎯 Tous secteurs",
      items: [
        { name: "Construction / BTP" },
        { name: "Industrie & Métallurgie" },
        { name: "Agroalimentaire" },
        { name: "Automobile & Équipementiers" },
        { name: "Logistique & Transport" },
        { name: "Hôtellerie-Restauration" },
        { name: "Agriculture & Sylviculture" },
        { name: "Plasturgie & Emballage" },
        { name: "Nettoyage & Services" }
      ]
    },
    testimonial: {
      badge: "⭐ Ils nous font confiance",
      quote: "YOJOB nous a permis de renforcer nos équipes de chantier en quelques jours avec des ouvriers qualifiés venus de Pologne. La gestion administrative a été totalement prise en charge par leur réseau d'agences partenaires. Un vrai gain de temps !",
      author: {
        name: "J.D.",
    ...
    faq: {
      ...
      title: "Vos questions sur l'intérim européen",
    ...
    ctaFinal: {
      ...
      title: "Prêt à recruter du personnel temporaire en Europe ?",
      subtitle: "Décrivez-nous votre besoin et recevez des profils qualifiés conformes après vérification des obligations légales",
      cta: "Demander un devis",
      features: "✓ Réponse sous 24h • ✓ Sans engagement"
    }
  },
  
  // Placeholder pour les autres pages (à compléter plus tard)
