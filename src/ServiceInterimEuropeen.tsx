        ...
        <section className="py-20 px-4 relative">
          <div className="container mx-auto">
            ...
            >
              ...
              <h2 className="text-white">Pourquoi choisir notre service d'intérim européen</h2>
            </motion.div>
        ...
        <section className="py-20 px-4 relative">
          <div className="container mx-auto">
            ...
            >
              ...
              <h2 className="text-white">Secteurs concernés par l'intérim européen</h2>
            </motion.div>
        ...
        <section className="py-20 px-4 relative">
          <div className="container mx-auto">
            ...
            >
              ...
              <h2 className="text-white">Vos questions sur l'intérim européen</h2>
            </motion.div>
