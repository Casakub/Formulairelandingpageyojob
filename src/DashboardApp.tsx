...
type TabId = 'overview' | 'results' | 'questions' | 'translations' | 'export' | 'integrations' | 'settings' | 'prospects' | 'agenda' | 'automations' | 'blog' | 'sitemaps';

const tabs = [
  { id: 'overview' as TabId, label: 'Vue d\'ensemble', icon: LayoutDashboard, color: 'from-blue-500 to-cyan-500' },
  { id: 'prospects' as TabId, label: 'Prospects', icon: Users, color: 'from-violet-500 to-purple-500' },
  { id: 'results' as TabId, label: 'Résultats', icon: BarChart3, color: 'from-emerald-500 to-green-500' },
  ...
  { id: 'sitemaps' as TabId, label: 'Sitemaps', icon: Map, color: 'from-violet-500 to-cyan-500' },
  ...
  { id: 'settings' as TabId, label: 'Paramètres', icon: Settings, color: 'from-slate-500 to-gray-500' },
];
...
export default function DashboardApp({ onBackToSurvey }: DashboardAppProps = {}) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
      <SEOHead 
        title="Dashboard Admin - YOJOB"
        description="Panneau d'administration YOJOB"
      />
