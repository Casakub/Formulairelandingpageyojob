  ...
  footer: {
    ...
    columns: {
      services: {
        title: 'Služby',
        links: [
          { label: 'Európska agentúrna práca', href: '#interim' },
          { label: 'Špecializovaný nábor', href: '#recrutement' },
          { label: 'Poradenstvo a súlad', href: '#conseil' },
          { label: 'Vyslanie pracovníkov', href: '#detachement' },
        ],
      },
      company: {
        title: 'Spoločnosť',
