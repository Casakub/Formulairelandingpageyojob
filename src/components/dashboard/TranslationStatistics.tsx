        ...
        <Card className="border-2 border-blue-200 bg-blue-50">
          <CardHeader>
            <CardTitle className="text-blue-900 flex items-center gap-2">
              ...
              📋 Diagnostic des traductions manquantes
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                <div className="bg-white/50 rounded-lg p-3 border border-blue-200">
                  <p className="text-xs text-blue-600 mb-1">📝 Questions du formulaire</p>
                ...
                <div className="bg-white/50 rounded-lg p-3 border border-blue-200">
                  <p className="text-xs text-blue-600 mb-1">🎨 Textes d'interface</p>
              ...
              <div className="bg-white/50 rounded-lg p-3 border border-blue-200 mt-3">
                <p className="text-xs text-blue-600 mb-2">🎯 Il manque en moyenne par langue :</p>
