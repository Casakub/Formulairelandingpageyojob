...
import { REGIONS, PAYS_EUROPEENS } from '../../data/config/constants';
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="md:col-span-2">
          ...
          <Select value={data.pays} onValueChange={(value) => handleChange('pays', value)} required>
            ...
            <SelectContent className="bg-white backdrop-blur-xl border border-gray-200 z-[9999] p-0 overflow-hidden">
              {PAYS_EUROPEENS.map((pays) => (
                <SelectItem 
                  key={pays} 
                  value={pays}
                  className="text-gray-900 hover:bg-slate-100 focus:bg-slate-100 cursor-pointer"
                >
